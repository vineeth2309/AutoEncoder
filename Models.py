...
class Unet(torch.nn.Module):
    def __init__(self, image_channels=3, hidden_size=32, n_classes=4):
        ...
        self.conv1 = DownBlockA(input_channels=image_channels, output_channels=filters[0])  # 256x112x32 = 9,17,504
        self.conv2 = DownBlockA(input_channels=filters[0], output_channels=filters[1])   # 128x56x128 = 9,17,504
        self.conv3 = DownBlockA(input_channels=filters[1], output_channels=filters[2])     # 64x28x512 = 9,17,504
        self.conv4 = DownBlockA(input_channels=filters[2], output_channels=filters[3])    # 32x14x1536 = 6,88,128
        ...
        # Decoder
        self.up1 = UpBlockB(input_channels=filters[4], output_channels=filters[3])     # 32x14x1536 = 6,88,128
        self.up2 = UpBlockB(input_channels=filters[3], output_channels=filters[2])    # 64x28x512 = 9,17,504
        self.up3 = UpBlockB(input_channels=filters[2], output_channels=filters[1])     # 128x56x128 = 9,17,504
        self.up4 = UpBlockB(input_channels=filters[1], output_channels=filters[0])       # 256x112x32 = 9,17,504
    ...
    def forward(self, x):
        ...
        self.out = self.conv_out(self.dec_layer4)
